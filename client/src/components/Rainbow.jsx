...
const Rainbow = props => (
  <div className="dblWrap">
    ...
    <div className="Glow-containers">
      <span className="Glow-container--start Glow-container--magenta">
      ...
      <span className="Glow-container--start Glow-container--purple">
      ...
      <span className="Glow-container--start Glow-container--blue">
      ...
      <span className="Glow-container--start Glow-container--green">
      ...
      <span className="Glow-container--start Glow-container--yellow">
      ...
      <span className="Glow-container--start Glow-container--orange">
      ...
      <span className="Glow-container--start Glow-container--red">
